...
public:
	...
	void create(Engine& eng, std::string vertshader, std::string fragshader, glm::vec3* vertexes, glm::vec2* uv, glm::vec3* normals, int size, char* pixels, glm::ivec2 TexResolution, int imagecount) {
		vs = vertshader;
		fs = fragshader;
